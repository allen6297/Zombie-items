...
public class ModCreativeTabs {
    ...
    public static final DeferredRegister<CreativeModeTab> CREATIVE_MODE_TABS =
            DeferredRegister.create(Registries.CREATIVE_MODE_TAB, ApocalypseItems.MODID);

    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> APOCALYPSE_ITEMS_TAB =
            CREATIVE_MODE_TABS.register("apocalypse_items", () -> CreativeModeTab.builder()
                    .title(Component.translatable("itemGroup.apocalypse_items"))
